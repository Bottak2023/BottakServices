      ...
      {modalInfo === false
        ? <form className='lg:h-full lg:py-[30px] w-full h-[400px] flex flex-col justify-between items-center  ' onSubmit={handlerTransfer}>
          ...
          <div className="">
            ...
            <br />
            <a className='flex justify-center text-[14px] text-white bg-transaparent border-[1px] border-yellow-300 rounded-[5px] px-2 py-2 max-w-[200px] md:max-w-[250px] lg:hidden' href="/bottak.apk" download>
