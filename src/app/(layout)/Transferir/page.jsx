                    ...
                    <div className='text-center w-full col-span-2 text-green-500 font-bold py-5 mb-5  md:flex md:justify.center' >
                        <h3 className='font-bold text-[14px] text-white uppercase flex items-center'>
                            ...
                            <p className='bg-gray-950 text-white text-left underline  underline-offset-8  decoration-green-500  px-3 py-2 rounded-[10px]  border border-green-500'>
                                {select !== 'USDT' ? 'Indica tu banco y tu numero de cuenta' : 'Indica tu billetera y direccion'}
                                <br />
                                {select !== 'USDT' ? 'desde donde haces la transferencia' : 'desde donde haces la transferencia'}
